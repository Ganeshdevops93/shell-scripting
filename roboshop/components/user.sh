...
sed -i -e 's/MONGO_DNSNAME/mongodb-ss.devopsb54.tk/' -e 's/REDIS_ENDPOINT/redis-ss.devopsb54.tk/' /home/roboshop/user/systemd.service && mv /home/roboshop/user/systemd.service /etc/systemd/system/user.service
Stat $?
