...
Print  "Extract user Component Code" "rm -rf /home/roboshop/user && cd /home/roboshop && unzip /tmp/user.zip && cd /home/roboshop/user"
rm -rf /home/roboshop/user && cd /home/roboshop && unzip /tmp/user.zip && cd /home/roboshop/user
Stat $?
